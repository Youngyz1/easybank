                ...
                <div class="login-form" style="width: 750px; position: relative; left: -20%;
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-sm-5" name="tax_residence" style="font-size:17px; font-weight:bold;" placeholder="Residence" pattern="[A-Z]{1,32}" title="Only uppercase" required>
