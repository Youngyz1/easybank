...
// FIX #2: Session timeout check at top level (not inside else)
...
// FIX #3: Generate CSRF token if not exists
...
<meta HTTP-EQUIV="REFRESH" content="600; url=/logout.php">
    ...
    <meta name="description" content="Easybank Online Banking">
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
            element.innerHTML = "i-code has expired. Request a new code";
        } else {
...
// FIX #4: Proper database connection handling (FIXED LOGIC)
if (!class_exists('DATABASE_CONNECT')) {
    error_log("DATABASE_CONNECT class not found");
    die("<div class='alert alert-danger'>System error: Database class not available.</div>");
}
...
if (!$conn) {
    ...
    die("<div class='alert alert-danger'>System error: Database connection failed.</div>");
}
...
if (!$stmt_user) {
    ...
    die("<div class='alert alert-danger'>System error occurred.</div>");
}
...
// FIX #5: Escape output to prevent XSS
...
if (!$row0) {
    ...
    die("<div class='alert alert-danger'>Account not found.</div>");
}
...
if (strpos($_SERVER['REQUEST_URI'], "?i_code_true") !== false) {
    ...
    // FIX #6: Use cryptographically secure random generation
    ...
    // FIX #8: Sanitize email for headers
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                     <img class="align-content" style="position: relative; left: -10%;" src="images/menu/transf0.png" height="70" width="80" alt="Transfer"> 
                      <h2 style="position: relative; left: -10%;"><span class="text-grey"><b> Easy Bank Transfer </b></span></h2>
                </div>
                ...
                <form action="" method="post" name="MyForm">
                   ...
                   <div class="form-group form-inline">
                         ...
                         <a href="transf_easy_bank.php?i_code_true">
                               <span class="text-grey"> Resend </span>
                        </a>
                              &nbsp; 
