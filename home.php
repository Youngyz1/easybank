...
<meta HTTP-EQUIV="REFRESH" content="900; url=/logout.php">
    ...
    .modal:before {
        content: ''; display: inline-block; height: 80%;
...
<body>
    ...
    <div id="right-panel" class="right-panel">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="actionsBtns">
                                            <form>
                                                ...
                                                &nbsp;
                                                <button type="submit" class="btn btn-default btn-primary btn-lg" data-dismiss="modal" onclick="window.location.href='logout.php'">
                                                    Logout <i class="fa fa-check"></i>
                                                </button>
                                            </form>
                                        </div>
                                    </div>
        ...
        if (class_exists('DATABASE_CONNECT')) {
            ...
            // ✅ Fixed SQL injection — prepared statement for user details
            $stmt = $conn->prepare("SELECT lastname, firstname, account_number, IBAN FROM customers WHERE email = ?");
            $stmt->bind_param("s", $email);
            $stmt->execute();
            $result_details_user = $stmt->get_result();
            ...
            // ✅ Fixed SQL injection — prepared statement for balance
        ...
        <div align="center">
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">Visa</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">Stripe</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">Paypal</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">Jcb</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">Mastercard</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">Discover</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">American Express</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card"><div class="card-body"><div class="stat-widget-one">
                    ...
                    <div class="stat-content dib"><div class="stat-text">Diners Club</div><div class="stat-digit"><i class="fa fa-euro"></i></div></div>
                </div></div></div>
            </div>
        </div>
